<style>
  ...
  .main-content {
    ...
    background: url('./images/flight/bg-mobile.webp');
...
<div class="reservation-container">
  <a href="tel:(888) 343-9911">
    <div class="header">
      <div class="header-title">Airline Reservations</div>
      <div class="phone-number">CALL US | 24/7: (888) 343-9911</div>
    </div>
      ...
      <div class="content-inner">
       ...
       Speak with Our Flight Specialists to Save Up to 40%
        ...
        <button class="cta-button">
          Call Us Now
          <span class="phone-large">(888) 343-9911</span>
        </button>
      </div>
    </div>

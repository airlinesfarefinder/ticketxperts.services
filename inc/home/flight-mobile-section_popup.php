...
<div id="cruise_banner">
    ...
    <a href="tel:(888) 343-9911"  style="text-decoration: none;" >
    <div class="head">All-In-One Reservation Desk</div>
            ...
            <button class="call_button">
                ...
                <div class="text">
                    <h3>exclusive call-only flight deals</h3>
                     ...
                     <a href="tel:(888) 343-9911"  style=" text-decoration: none;font-size:30px;font-weight:bolder; color:white "    >(888) 343-9911</a>
                </div>
            </button>
        </div>
...
">
    ...
    <button class="call_button"  >
        ...
        <div class="text">
            ...
            <a href="tel:(888) 343-9911"  style=" text-decoration: none; font-size: 30px;
    font-weight: bolder; "    >(888) 343-9911 </a>
        </div>
    </button>

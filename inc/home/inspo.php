            ...
            <div class="col-sm-6">
                <div class="inspo_item">
                    <div class="inspo_info">
                        ...
                        <a href="tel:(888) 343-9911"><button>Browse Car Deals</button></a>
                    </div>
                    ...
                    <div class="inspo_img"
                        ...
                        style=" 
                     background-image: url('./images/store/15.jpeg');
            ...
            <div class="col-sm-6">
                <div class="inspo_item">
                    <div class="inspo_info">
                        ...
                        <a href="tel:(888) 343-9911"><button>Take the Quiz</button></a>
                    </div>
                    ...
                    <div class="inspo_img"
                        ...
                        style=" 
                     background-image: url('./images/store/11.jpeg');
                       /* clip-path: polygon(0 100%, 20% 0, 100% 0, 100% 100%); */
                    ">
            ...
            <div class="col-sm-6">
                <div class="inspo_item">
                    ...
                    <div class="inspo_img"
                        ...
                        style=" 
                     background-image: url('./images/store/17.jpeg');
                        /* clip-path: polygon(0 100%, 20% 0, 100% 0, 100% 100%); */
                    ">
            ...
            <div class="col-sm-6">
                <div class="inspo_item">
                    ...
                    <div class="inspo_img"
                        ...
                        style=" 
                     background-image: url('./images/store/41.jpeg');
                       /* clip-path: polygon(0 100%, 20% 0, 100% 0, 100% 100%); */
                    ">

...
<div id="cruise_banner">
  ...
  <a href="tel:(888) 711-6010"></a>
  <div class="head">Car-Rent Helpline</div>
 ...
 <a href="tel:(888) 711-6010"  style=" text-decoration: none; font-size:30px; color:white; font-weight:bolder; "    >(888) 711-6010</a>
  ...
  <button class="call_button">
    ...
    <div class="text">
      <h3>Get Rolling with <span>Up to 60%</span> Off Rental Rates!</h3>
       ...
       <a href="tel:(888) 711-6010"  style=" text-decoration: none;font-size: 30px;
    font-weight: bolder;  "    >(888) 711-6010 </a>
    </div>
  </button>
</div>
</a>
